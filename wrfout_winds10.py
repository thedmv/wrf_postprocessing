...
for filename in ncflist:
    ...
    u10 = np.squeeze(wrfobj.variables['U10'].data)
    v10 = np.squeeze(wrfobj.variables['V10'].data)
    ...
    mp.pcolormesh(lon, lat, var, latlon=True, vmin = 0, vmax = 15)
    ...
    figname = './wrfvar_winds10' + "__" + datetitle
    plt.title('Wind Magnitude (m/s) ' + datetitle)
